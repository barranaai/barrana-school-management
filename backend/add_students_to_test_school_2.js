...
const connectDB = async () => {
  try {
    ...
    console.log('📊 MongoDB Connected for adding test students to Test School 2');
  } catch (error) {
...
const testStudents = [
  // Grade 1A - 5 students
  {
    firstName: "Emma",
    lastName: "Johnson",
    email: "emma.johnson@testschool2.com",
  ...
  },
  {
    firstName: "Liam",
    lastName: "Williams",
    email: "liam.williams@testschool2.com",
    role: "parent",
    studentGrade: "Grade 1",
    studentClass: "Grade 1A",
  ...
  },
  {
    firstName: "Olivia",
    lastName: "Brown",
    email: "olivia.brown@testschool2.com",
    role: "parent",
    studentGrade: "Grade 1",
    studentClass: "Grade 1A",
  ...
  },
  {
    firstName: "Noah",
    lastName: "Davis",
    email: "noah.davis@testschool2.com",
    role: "parent",
    studentGrade: "Grade 1",
    studentClass: "Grade 1A",
  ...
  },
  {
    firstName: "Ava",
    lastName: "Miller",
    email: "ava.miller@testschool2.com",
    role: "parent",
    studentGrade: "Grade 1",
    studentClass: "Grade 1A",
  ...
  // Grade 1B - 5 students
  {
    firstName: "Ethan",
    lastName: "Wilson",
    email: "ethan.wilson@testschool2.com",
    role: "parent",
    studentGrade: "Grade 1",
  ...
  },
  {
    firstName: "Sophia",
    lastName: "Taylor",
    email: "sophia.taylor@testschool2.com",
    role: "parent",
    studentGrade: "Grade 1",
    studentClass: "Grade 1B",
  ...
  },
  {
    firstName: "Mason",
    lastName: "Anderson",
    email: "mason.anderson@testschool2.com",
    role: "parent",
    studentGrade: "Grade 1",
    studentClass: "Grade 1B",
  ...
  },
  {
    firstName: "Isabella",
    lastName: "Thomas",
    email: "isabella.thomas@testschool2.com",
    role: "parent",
    studentGrade: "Grade 1",
    studentClass: "Grade 1B",
  ...
  },
  {
    firstName: "William",
    lastName: "Jackson",
    email: "william.jackson@testschool2.com",
    role: "parent",
    studentGrade: "Grade 1",
    studentClass: "Grade 1B",
  ...
  // Grade 2A - 5 students
  {
    firstName: "James",
    lastName: "White",
    email: "james.white@testschool2.com",
    role: "parent",
  ...
  },
  {
    firstName: "Charlotte",
    lastName: "Harris",
    email: "charlotte.harris@testschool2.com",
    role: "parent",
    studentGrade: "Grade 2",
    studentClass: "Grade 2A",
  ...
  },
  {
    firstName: "Benjamin",
    lastName: "Clark",
    email: "benjamin.clark@testschool2.com",
    role: "parent",
    studentGrade: "Grade 2",
    studentClass: "Grade 2A",
  ...
  },
  {
    firstName: "Mia",
    lastName: "Lewis",
    email: "mia.lewis@testschool2.com",
    role: "parent",
    studentGrade: "Grade 2",
    studentClass: "Grade 2A",
  ...
  },
  {
    firstName: "Lucas",
    lastName: "Robinson",
    email: "lucas.robinson@testschool2.com",
    role: "parent",
    studentGrade: "Grade 2",
    studentClass: "Grade 2A",
  ...
  // Grade 2B - 5 students
  {
    firstName: "Amelia",
    lastName: "Walker",
    email: "amelia.walker@testschool2.com",
    role: "parent",
    studentGrade: "Grade 2",
  ...
  },
  {
    firstName: "Henry",
    lastName: "Perez",
    email: "henry.perez@testschool2.com",
    role: "parent",
    studentGrade: "Grade 2",
    studentClass: "Grade 2B",
  ...
  },
  {
    firstName: "Harper",
    lastName: "Hall",
    email: "harper.hall@testschool2.com",
    role: "parent",
    studentGrade: "Grade 2",
    studentClass: "Grade 2B",
  ...
  },
  {
    firstName: "Alexander",
    lastName: "Young",
    email: "alexander.young@testschool2.com",
    role: "parent",
    studentGrade: "Grade 2",
    studentClass: "Grade 2B",
  ...
  },
  {
    firstName: "Evelyn",
    lastName: "Allen",
    email: "evelyn.allen@testschool2.com",
    role: "parent",
    studentGrade: "Grade 2",
    studentClass: "Grade 2B",
...
// Function to add test students to Test School 2
const addTestStudentsToTestSchool2 = async () => {
  try {
    console.log('🚀 Starting to add test students to Test School 2...');
    ...
    // Insert students
    console.log('📝 Adding students to Test School 2...');
    ...
    console.error('❌ Error adding test students to Test School 2:', error);
  } finally {
...
// Run the script
connectDB().then(addTestStudentsToTestSchool2); 